...
| **M5 Progress** | The 8→12 arc renders with the callout; ≤2 data points fall back to number cards; a fresh elder shows explainer empty states. |
...
3. **Clinical proof (30s):** Progress — chair-stand chart climbing 8→12 with the "naik dari 8!" callout and streak dots. The pitch line: fall-risk measurably decreasing over WhatsApp.
